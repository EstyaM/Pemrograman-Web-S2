...
clickedHand=["<img src='rock.png' id='img1'>", "<img src='paper.png' id='img1'>", 
"<img src='scissors.png' id='img1'>"];

clickeRightdHand=["<img src='rock.png' id='img2'>", "<img src='paper.png' id='img2'>", 
...
function game(position){
    ...
    setTimeout(() => {
        document.getElementById("hand2").innerHTML=clickeRightdHand[random];
